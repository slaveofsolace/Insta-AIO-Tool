...
| Chrome extension | `Insta-Toolbox-Extension-3.1.6.zip` |
| Web/PWA | `insta-toolbox-web-3.1.6.zip` |
| Windows | `Insta-Toolbox-Setup-3.1.6.exe` |
| macOS | `Insta-Toolbox-3.1.6-universal.dmg` and `.zip` |
...
- service-worker cache generation `insta-toolbox-v316`.
...
The candidate record is [acceptance/3.1.6.md](./acceptance/3.1.6.md). Compatibility is tracked in [compatibility/3.1.6.md](./compatibility/3.1.6.md).
