...
| Chrome extension | `Insta-Toolbox-Extension-3.1.11.zip` |
| Web/PWA | `insta-toolbox-web-3.1.11.zip` |
| Windows | `Insta-Toolbox-Setup-3.1.11.exe` |
| macOS | `Insta-Toolbox-3.1.11-universal.dmg` and `.zip` |
...
- service-worker cache generation `insta-toolbox-v3111`.
...
The candidate record is [acceptance/3.1.11.md](./acceptance/3.1.11.md). Compatibility is tracked in [compatibility/3.1.11.md](./compatibility/3.1.11.md).
