...
| Chrome extension | `Insta-Toolbox-Extension-3.1.5.zip` |
| Web/PWA | `insta-toolbox-web-3.1.5.zip` |
| Windows | `Insta-Toolbox-Setup-3.1.5.exe` |
| macOS | `Insta-Toolbox-3.1.5-universal.dmg` and `.zip` |
...
- service-worker cache generation `insta-toolbox-v315`.
...
The candidate record is [acceptance/3.1.5.md](./acceptance/3.1.5.md). Compatibility is tracked in [compatibility/3.1.5.md](./compatibility/3.1.5.md).
