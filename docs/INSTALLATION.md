...
1. Download `Insta-Toolbox-Extension-3.1.9.zip` from the [latest release](https://github.com/slaveofsolace/Insta-Toolbox/releases/latest).
...
1. Download `Insta-Toolbox-Setup-3.1.9.exe` and `SHA256SUMS.txt` from the [latest release](https://github.com/slaveofsolace/Insta-Toolbox/releases/latest).
...
1. Download the recommended `Insta-Toolbox-3.1.9-universal.dmg` and `SHA256SUMS.txt` from the [latest release](https://github.com/slaveofsolace/Insta-Toolbox/releases/latest).
2. Verify the checksum.
...
The release also includes `Insta-Toolbox-3.1.9-universal.zip` as a portable alternative. Verify its checksum, extract it, and move **Insta Toolbox** to Applications. It contains the same universal app and has the same signing and notarization limits as the DMG.
...
1. Download `insta-toolbox-web-3.1.9.zip` from the [latest release](https://github.com/slaveofsolace/Insta-Toolbox/releases/latest).
...
Get-FileHash .\Insta-Toolbox-Extension-3.1.9.zip -Algorithm SHA256
```
...
shasum -a 256 insta-toolbox-web-3.1.9.zip
```
...
- [3.1.9 acceptance record](acceptance/3.1.9.md)
- [3.1.9 compatibility](compatibility/3.1.9.md)
